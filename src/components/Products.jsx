...
const Products = () => {
  return (
    ...
    <div className="text-black text-center font-roboto font-bold text-2xl mt-20">
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 mt-6">
        <ProductCard
    ...
    <div id='best-sellers' className='mt-12'>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 mt-6 mb-20">
        <BestSellers 
